    ...
    <div style={{ backgroundImage: `url(${background})` }} className="bg-cover bg-center flex justify-center items-center h-screen">
          <div className="w-full md:w-[25%] min-h-[33vh] flex flex-col bg-gray-800 p-8 shadow-lg rounded-2xl">
            ...
            <div className="flex mt-[3rem] flex-col">
              ...
              <input type="password" placeholder=" *********" className="bg-gray-900 h-[4rem] w-[40rem] rounded-2xl"></input>
            </div>
            <button className="w-[40%] h-[4rem] self-center bg-gray-900 mt-[3rem] font-thin text-2xl rounded-3xl shadow-lg hover:bg-blue-900 duration-300">Sign in</button>
          </div>
        </div>
