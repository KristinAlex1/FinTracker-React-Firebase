      ...
      <div className="flex bg-black items-center justify-center min-h-[6rem] relative px-4">
        ...
        <div className="w-full md:w-[80%] h-auto md:h-[5rem] bg-gray-900 rounded-lg mt-[2rem] font-thin flex flex-col md:flex-row items-center justify-between px-4 md:px-6 bg-gradient-to-r from-gray-800/60 via-blue-600/30 to-gray-700/60 shadow-lg">
          ...
          <div className="text-lg md:text-2xl flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 mt-2 md:mt-0">
            ...
            <Link to="/signup" className="px-4 py-2 bg-gray-100 text-black font-semibold rounded-lg transition-all duration-300 ease-in-out hover:bg-gray-900 hover:text-white text-center">
              Get Started
            </Link>
          </div>
        </div>
